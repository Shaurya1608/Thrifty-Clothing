...
const Products = () => {
  ...
  const filteredProducts = products.filter(product => {
    ...
    if (selectedCat === 'men') {
      return productCategory?.includes('men') || productCategory?.includes('male');
    } else if (selectedCat === 'women') {
      return productCategory?.includes('women') || productCategory?.includes('female');
    } else if (selectedCat === 'objects') {
      return productCategory?.includes('accessory') || productCategory?.includes('object');
    }
